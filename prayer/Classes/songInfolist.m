...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	NSDictionary *item = (NSDictionary *)[resourceData objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	YouTubeView *youtubeviewcontroller = [[YouTubeView alloc] initWithNibName:@"YouTubeView" bundle:nil];

	youtubeviewcontroller.rownum = indexPath.row;
	
	//[youtubeviewcontroller setRownum:indexPath.row];
